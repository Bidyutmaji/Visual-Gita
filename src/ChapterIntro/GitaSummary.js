...
function GitaSummary( { data } ) {
    ...
    return (
        <div className='flex flex-col lg:flex-row lg:justify-center items-center w-full h-full  border border-rose-200 bg-[#FFEFD5] rounded-xl overflow-y-auto'>
            <div className={`w-[90%] ${data.imageWidth} lg:h-[90%] flex flex-col justify-center items-center lg:pl-2 pt-2`}>
            ...
            <div className={`py-9 lg:pt-0 w-[90%] ${data.tableWidth} lg:h-[90%] flex flex-col lg:justify-start lg:items-center`}>
