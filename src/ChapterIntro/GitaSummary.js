...
function GitaSummary( { data } ) {
    ...
    return (
        <div className='flex justify-center items-center w-full h-full  border border-rose-200 bg-[#FFEFD5] rounded-xl'>
            <div className='w-[25%] h-[90%] flex flex-col  justify-center items-center pl-2 pt-2'>
            ...
            <div className='w-[75%] max-h-[95%] h-[95%] flex flex-col justify-center items-center'>
            ...
            <table className='p-5 border-separate border-spacing-1'>
                    <thead className=''>
                        <tr className=''>
