        ...
        <div className='w-[65%] '>
            ...
            <div className='flex justify-center items-baseline space-x-2'>
                <div className='flex flex-col items-center space-y-9'>
                    <p className='px-[50px] py-[30px] bg-emerald-300 border border-emerald-500 rounded-lg text-xl'>Work</p>
                ...
                <div className='flex flex-col items-center space-y-9'>
                    <p className="px-[50px] py-[30px] bg-rose-300 border border-rose-500 rounded-lg text-xl">Loving Devotion</p>
                    <BsChevronDoubleDown size={30} className='font-bold text-gray-800' />
                ...
                <div className='flex flex-col items-center space-y-9'>
                    <p className='px-[50px] py-[30px] bg-blue-300 border border-blue-500 rounded-lg text-xl'>Knoweldge</p>
                    <BsChevronDoubleDown size={30} className='font-bold text-gray-800' />
